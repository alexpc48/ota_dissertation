...
def options_menu() -> str:
    ...
    print("-------------------------------------------------------------------------------------------")
    print("30. [DEMO] Connect with invalid TLS certificate")
    print("31. [DEMO] Use invalid encryption key")
    print("32. [DEMO] Send malicious payload (hash failure)")
    print("33. [DEMO] Send malicious payload (digital signature failure)")
    print("-------------------------------------------------------------------------------------------")
